CALL-E: Your Code Is Calling (the “Hackathon”) Official Rules
...
1. Dates and Timing
Submission Period: July 23, 2026 (9:30 pm SGT) – September 14, 2026 (11:45 am SGT) (“Submission Period”).

Feedback Period: July 23, 2026 (9:30 pm SGT) – September 18 (11:45 pm SGT) (“Feedback Period”).

Judging Period: September 30, 2026 (10:00 am SGT) – October 13, 2026 (5:00 pm SGT) (“Judging Period”).

Winners Announced: On or around October 19, 2026 (2:00 pm SGT).

 

2. Sponsor and Administrator
Sponsor and Administrator: AIRUDDER Pte Ltd, 182 Cecil Street #23-02 Fraser Tower, Singapore 069547 (the “Sponsor”)
...
4. How To Enter
Entrants may enter by visiting call-e.devpost.com (“Hackathon Website”) and following the below steps:
...
Access to CALL-E may be obtained by (1) receiving 20 free CALL-E calls upon creating a new account (follow the setup instructions at https://github.com/CALLE-AI/call-e-integrations) or (2) using an existing CALL-E account for which you may request an additional 200 calls  by completing this form. Approved additional call requests allocated to your CALL-E account are generally processed within one (1) to five (5) business days of completing the form, while supplies last. The availability, amount, and approval of any CALL-E additional calls are subject to the Sponsor’s sole discretion and are not guaranteed. If you use all of the calls allocated to your account, your CALL-E access will simply pause — you will not be automatically charged any fees. Continuing beyond your allocated calls is optional and would require you to purchase additional calls
To be considered for the Most Valuable Feedback bonus prizes, Entrants must be registered for the hackathon on Devpost and complete the online CALL-E Feedback Survey form (each a “Feedback Submission”). Feedback must be submitted during the Feedback Period. To be eligible for a Feedback Prize, the Feedback Submission must be complete with actionable comments that the Sponsor can use to improve CALL-E or related documentation (for example, bug reports, user interface improvements, suggested integrations, and more). One Feedback Submission per Entrant.
...
What to Create: Entrants must create a functional software application that uses CALL-E's API or SDKs for Python/TypeScript, or integrates CALL-E Skill or MCP to create functionality on top of modern agent environments, such as Codex, ChatGPT, or Claude Code, for an impactful business or project use case (each a “Project”).
...
Stage One) The first stage will determine via pass/fail whether the ideas meet a baseline level of viability, in that the Project reasonably fits the theme and reasonably applies CALL-E APIs, SDKs, MCP, or Skill integrations featured in the Hackathon.
...
Real World Impact
Does the project identify a real, specific phone-work problem and make a credible case that it solves it for real users? A strong project points to a direction worth building further for real users after the hackathon — not a generic "AI that makes phone calls" concept.
Quality of the Idea
...
Each individual entrant is eligible for one Most Valuable Feedback Prize. Eligible individuals who only submit Most Valuable Feedback Surveys will NOT be eligible for any additional prizes. Feedback Prizes are awarded to individuals, not to Projects and will not be visible on the platform.
